  ...
  internal = rec {
    ...
    crates = {
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "basetsd" "consoleapi" "errhandlingapi" "fileapi" "handleapi" "impl-default" "memoryapi" "minwinbase" "minwindef" "ntdef" "processenv" "std" "sysinfoapi" "winbase" "winnt" "winsock2" "ws2ipdef" "ws2tcpip" ];
      };
